...
CREATE TABLE IF NOT EXISTS reservations (
    ...
    KEY user_reserved_idx (user_id, reserved_at),
    KEY user_canceled_idx (user_id, canceled_at),
    KEY event_id_and_sheet_id_idx (event_id, sheet_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS recent_event (
    reservation_id INTEGER UNSIGNED PRIMARY KEY,
    change_at  DATETIME(6)      NOT NULL,
    event_id    INTEGER UNSIGNED NOT NULL,

    KEY change_idx (change_at, event_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
